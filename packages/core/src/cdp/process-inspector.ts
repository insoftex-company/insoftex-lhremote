...
// ---------------------------------------------------------------------------
// Command-line acquisition (Windows: WMI; others: ps-list cmd field)
// ---------------------------------------------------------------------------
 ...
 *
 * Raw command lines are NEVER exported — only allowlisted identity fields
 * extracted from them leave this module.
 */
async function gatherRawProcesses(): Promise<RawProcess[]> {
